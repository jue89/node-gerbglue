...
const ExcellonSlottedHoleReader = require( './excellon-slotted-hole.js' );
	...
	_interpreteLine( line ) {
		...
		if( this._mode === M_HEADER && HeaderEndRE.test( line ) ) {
			...
			this._reader = {
				...
				slottedHole: new ExcellonSlottedHoleReader( this._srcFormat, this._dstFormat, this._boundaries )
			};
			return;
		}
