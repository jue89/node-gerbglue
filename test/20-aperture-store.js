...
describe( "Class ApertureStore", () => {
	...
	it( 'should read metric apertures and convert them to imperial system', ( done ) => {
		...
		const input = [
			...
			'%ADD13O,2.286000X2.286000X0.100000*%',
			'%ADD14C,6.654000*%',
			'%ADD15C,2.654000*%',
			'%ADD16C,2.554000*%',
			'%ADD17R,1.504000X1.254000*%',
			'%ADD18R,1.154000X1.954000X0.100000*%',
			'%ADD19R,2.082800X1.270000*%',
			'%ADD20R,1.270000X2.082800*%'
		];
		...
		const output = [
			...
			"%ADD13R,0.090000X0.090000X0.003937*%",
			"%ADD14C,0.261969*%",
			"%ADD15C,0.104488*%",
			"%ADD16C,0.100551*%",
			"%ADD17R,0.059213X0.049370*%",
			"%ADD18R,0.045433X0.076929X0.003937*%",
			"%ADD19R,0.082000X0.050000*%",
	...
	it( 'should read metric apertures from one job and imperial apertures from another job and merge / convert them to imperial system', ( done ) => {
		...
		const input2 = [
			...
			"%ADD23R,0.090000X0.090000X0.003937*%",
			"%ADD24C,0.261969*%",
			"%ADD25C,0.104488*%",
			"%ADD26C,0.100551*%",
			"%ADD27R,0.059213X0.049370*%",
			"%ADD28R,0.045433X0.076929X0.003937*%",
			"%ADD29R,0.082000X0.050000*%",
			"%ADD30R,0.050000X0.082000*%"
		];
